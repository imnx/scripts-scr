...
apt-get -qy install openssh-server cifs-utils samba curl sudo perl-base gpm gfxboot gxfboot-themes \
plymouth plymouth-themes plymouth-theme-hamara open-vm-tools-dev python python-pip wget net-tools apt-utils \
psmisc dnsutils dialog pv build-essential cmake bison flex nasm yasm automake autoconf autogen autopoint \
autoproject autotools-dev libtool intltool doxygen texinfo texi2html byacc git cvs subversion mercurial \
mc irssi libpurple-dev libjson-glib-dev libncurses5-dev libncursesw5-dev chromium gnome-desktop gdm3 xserver-xorg \
xorg-core
...
GRUB_CMDLINE_LINUX='net.ifnames=0 splash quiet'

GRUB_GFXMODE='1360x768'
GRUB_GFXPAYLOAD='1360x768'
GRUB_THEME=''
